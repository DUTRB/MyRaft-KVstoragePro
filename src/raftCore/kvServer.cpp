...
/**
 * 插入元素，与 ExecuteAppendOpOnKVDB 函数操作完全一致
 * @param op
 */
...
/**
 * 处理来自clerk的 Get RPC
 * @param args 定义在 kvserverRPC.proto 文件中的参数
 * @param reply
 */
void KvServer::Get(const raftKVRpcProctoc::GetArgs *args,
  ...
  // ，虽然是预计，但是正确情况下是准确的，op的具体内容对raft来说是隔离的
...
// get和putappend执行的具体细节不一致
// PutAppend在收到raft消息之后执行
