 ...
 * @LastEditTime: 2024-05-12 10:31:10
 * @FilePath: /myRaft/example/fiberExample/server.cpp
 * @Description: 监听8080端口，接受客户端的连接请求，并与之进行通信。
 */
#include <arpa/inet.h>
#include <fcntl.h>
#include <string.h>
...
void test_iomanager() {
    ...
    // 创建一个monsoon::IOManager实例，并添加一个事件监听器，当监听套接字可读时，调用test_accept函数。
